...
@section('links')
    ...
    <script src="https://cdn.tiny.cloud/1/30h4n7mvg0u2p41o4jsx8y4fb4ev21mqq6j8xbs3nmbgf236/tinymce/5/tinymce.min.js"
...
@section('content')
                                ...
                                <div class="example">
                                    <div class="example-preview">
                                        ...
                                        <div class="tab-content mt-5" id="myTabContent1">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6">
                                                            ...
                                                            <div class="card card-custom bgi-no-repeat gutter-b card-stretch"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="p-4">
                                                                        <h3 class="text-success font-weight-bolder my-7">
                                                                            Create CRM Reports</h3>
                                                                        <a href='#'
                                                                            class="btn btn-danger font-weight-bold px-6 py-3">Create
                                                                            Report</a>
                                                                    </div>
                                                                </div>
                                                                <!--end::Body-->
                                                                                        ...
                                                                                        <div class="modal-header">
                                                                                            ...
                                                                                            <button type="button"
                                                                                                ...
                                                                                                <span aria-hidden="true"
                                                                                                    style="display:block;">&times;</span>
                                                                                            </button>
                                                                                        </div>

                                                                                        <div class="modal-body">
                                                                                            <div id="subtask_description{{ $items->id }}"
                                                                                                class="{{ $items->Description == null ? 'nulled_task' : 'Sub_task_description' }} sub_task_description"
                                                                                                data-ivalue={{ $items->id }}>
                                                                                            ...
                                                                                            <div class="d-flex ">
                                                                                                ...
                                                                                                @foreach ($subtask_employee[$i] as $member[$i])
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div class="ml-2 "
                                                                                                            ...
                                                                                                            <span
                                                                                                                class="tool"
                                                                                                                data-tip="{{ $member[$i]->name }} | {{ $member[$i]->position }}">
                                                                                                                <i style="font-size: 25px; line-height:35px;"
                                                                                                                    class="far fa-user-circle mr-2"></i>
                                                                                                            </span>
                                                                                                        </div>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div class="ml-2 "
                                                                                                        ...
                                                                                                        data-toggle="dropdown"
                                                                                                        aria-expanded="false">
                                                                                                        <i class=" flaticon-add-circular-button "
                                                                                                    ...
                                                                                                    <div class="dropdown-menu"
                                                                                                        ...
                                                                                                        @foreach ($employee as $person)
                                                                                                            <a class="dropdown-item"
                                                                                                                href="{{ route('manager.assign_subtask', [$items->id, encrypt($person->id)]) }}">{{ $person->name }}
                                                                                                            </a>
                                                                                                        @endforeach
                                                                                                    </div>
                                                                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="profile-1" role="tabpanel"
                                                            ...
                                                            <div class="card  card-custom  gutter-b">
                                                                <div class="card-body ">
                                                                    ...
                                                                    Project Manager Not Assigned. <a href="#"
                                                                        data-toggle="modal"
                                                                        data-target="#staticBackdrop">Assign Now?</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        <tbody class="text-center">
                                                                            @foreach ($employee as $item)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <form method="POST"
                                                                                            action="{{ route('manager.assign_project_manager', $project->id) }}">
                                                                                            @csrf
                                                                                            <button
                                                                                                class="btn btn-sm btn-primary"
                                                                                                type="submit"
                                                                                                name="project_manager"
                                                                                                value="{{ $item->id }}">Assign</button>
                                                                                        </form>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="row align-items-center justify-content-center pt-2"
                                                                    ...
                                                                    <i class=" flaticon-add-circular-button mr-2"
                                                                        style="font-size:40px;"></i>
                                                                    <a href="#"
                                                                        class="card-title font-size-h5  text-hover-primary text-muted mb-0">Add
                                                                        Role</a>
                                                                </div>
                                                            ...
                                                            <div class="modal fade" id="exampleModal" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="exampleModalLabel">Add Member</h5>
                                                                        </div>
                                                                        <form method="POST"
                                                                            action={{ route('manager.update_project_member', $project->id) }}>
                                                                            @csrf
                                                                            <div class="modal-body">
                                                                                <div class="form-row">
                                                    ...
                                                    @foreach ($employee as $item)
                                                                ...
                                                                <div class="card-body d-flex align-items-center py-0 mt-8">
                                                                    <div
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-10">
                                                                                <a href="#"
                                                                                    ...
                                                                                    data-toggle="modal"
                                                                                    data-target="#employeeModal{{ $item->id }}">{{ $item->name }}</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col">
                                                                                <span
                                                                                    class="font-weight-bold text-muted font-size-lg">{{ $item->position }}</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="modal fade" id="employeeModal{{ $item->id }}"
                                                            tabindex="-1"
                                                            aria-labelledby="employeeModal{{ $item->id }}"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-md-6 text-center">
                                                                                <form method="POST"
                                                                                    action="{{ route('manager.remove_member', $project->id) }}">
                                                                                    @csrf
                                                                                    <button type="submit"
                                                                                        class="btn btn-lg btn-danger"
                                                                                        name="member_id"
                                                                                        value={{ $item->id }}
                                                                                        @if ($item->id == $project_manager) disabled @endif><i
                                                                            ...
                                                                            <div class="col-md-6 text-center">
                                                                                @if ($item->id == $project_manager)
                                                                                    <form method="POST"
                                                                                        action="{{ route('manager.remove_p_manager', $project->id) }}">
                                                                                        @csrf
                                                                                        <button type="submit"
                                                                                            name="member_id"
                                                                                            value={{ $item->id }}
                                                                                    ...
                                                                                    <form method="POST"
                                                                                        ...
                                                                                        <button type="submit"
                                                                                            ...
                                                                                            class="btn btn-lg btn-info"><i
                                                                                                class="fas fa-people-arrows"></i></i>Change
                                                                                            P.Manager</button>
                                                                                    </form>
                                                                                @endif
                                            ...
                                            <div class="tab-pane fade" id="demo-1" role="tabpanel"
                                                ...
                                                <div class="card card-custom gutter-b">
                                                    ...
                                                    <div class="card-body">
                                                        <form method="POST"
                                                            action="{{ route('manager.add_project_file', encrypt($project->id)) }}"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group mb-1">
                                                                <textarea class="form-control" id="exampleTextarea" name="description"></textarea>
                                                            </div>
                            ...
                            <div id="">
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body" id="discussion_panel">
                                        <div class="card">
                                            <div class="card-body" id="message_panel"
                                                @if ($project->status == 'complete') style="height: 70vh; overflow:hidden; @endif">
                                                <div class="g-0">
                                                            ...
                                                            <div class="chat-messages p-4">
                                                                ...
                                                                <div class="chat-message-left pb-4">
                                                                    <div>
                                                                        ...
                                                                        <div class="text-muted small text-nowrap mt-2">2:34
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                                        <div class="font-weight-bold mb-1">Sharon Lessman
                                                                        </div>
                                                                ...
                                                                <div class="chat-message-right mb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png"
                                                                            class="rounded-circle mr-1" alt="Chris Wood"
                                                                            width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:35
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                                ...
                                                                <div class="chat-message-left pb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar3.png"
                                                                            class="rounded-circle mr-1"
                                                                            alt="Sharon Lessman" width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:36
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                                        ...
                                                                        et velit.
                                                                        Proin ultricies placerat imperdiet. Morbi varius
                                                                ...
                                                                <div class="chat-message-left pb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar3.png"
                                                                            class="rounded-circle mr-1"
                                                                            alt="Sharon Lessman" width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:37
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                                ...
                                                                <div class="chat-message-right mb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png"
                                                                            class="rounded-circle mr-1" alt="Chris Wood"
                                                                            width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:38
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                                ...
                                                                <div class="chat-message-left pb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar3.png"
                                                                            class="rounded-circle mr-1"
                                                                            alt="Sharon Lessman" width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:39
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                                ...
                                                                <div class="chat-message-right mb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png"
                                                                            class="rounded-circle mr-1" alt="Chris Wood"
                                                                            width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:40
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                                ...
                                                                <div class="chat-message-right mb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png"
                                                                            class="rounded-circle mr-1" alt="Chris Wood"
                                                                            width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:41
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                                ...
                                                                <div class="chat-message-left pb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar3.png"
                                                                            class="rounded-circle mr-1"
                                                                            alt="Sharon Lessman" width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:42
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                                ...
                                                                <div class="chat-message-right mb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png"
                                                                            class="rounded-circle mr-1" alt="Chris Wood"
                                                                            width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:43
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                                ...
                                                                <div class="chat-message-left pb-4">
                                                                    <div>
                                                                        <img src="https://bootdey.com/img/Content/avatar/avatar3.png"
                                                                            class="rounded-circle mr-1"
                                                                            alt="Sharon Lessman" width="40" height="40">
                                                                        <div class="text-muted small text-nowrap mt-2">2:44
                                                                            am</div>
                                                                    </div>
                                                                    <div
                                                                        class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                        ...
                                        @else
                                            <div id="message_box">
                                                <form method="POST"
                                                    action="{{ route('manager.add_discussion', $project->id) }}">
                                                    @csrf
    ...
    <div class="position-fixed bottom-0 right-0 p-3" style="z-index: 5; right: 0; bottom: 0;">
        <div id="liveToast" class="toast hide toast-success" role="alert" aria-live="assertive" aria-atomic="true"
            data-delay="2000" style="height: 80px; width:450px;">
