                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                            ...
                            <li
                                class="menu-item {{ request()->routeIs('admin.view_clients') ? 'menu-item-active' : '' }}">
                                <a href="{{ route('admin.view_clients') }}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                        ...
                                                        <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Edit Team
                                                                        Member</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Delete Team
                                                                        Member</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Team Member
                                                                        Reports</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Promote Team
                                                                        Member</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                        ...
                                                        <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Completed
                                                                        Projects</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                ...
                                                <ul class="menu-content">
                                                        ...
                                                        <ul class="menu-inner">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Quarterly
                                                                        Profits</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                        ...
                                                        <ul class="menu-inner">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Development
                                                                        Staff</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Sales and
                                                                        Marketing</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    <li class="menu-item">
                                                        ...
                                                        <ul class="menu-inner">
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    <span class="menu-text">Analytical
                                                                        Reports</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    <span class="menu-text">Operational
                                                                        Growth</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                        ...
                                                        <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">User Dropout
                                                                        Points</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                            ...
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="javascript:;" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Opportunity
                                                                        Growth</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://www.thedevgarden.com" target="_blank"
                                class="text-dark-75 text-hover-primary">TheDevGarden <span id="love">&#10084;</span>
                            </a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Nav-->
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a href="{{ route('admin.my_profile') }}" class="navi-item">
                    <div class="navi-link">
