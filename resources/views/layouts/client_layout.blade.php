		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
                                            @foreach ( $clientProject as $projects  )
                                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">

                                                    <a href="{{ route("client.single_project",$projects->id) }}" class="menu-link menu-toggle">
                                                        <i class="menu-bullet menu-bullet-line">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">{{ $projects->name }}</span>
                                                    </a>
                                                </li>
                                            @endforeach
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<!--begin::Footer-->
					<div class="footer bg-white py-4 d-flex flex-lg-column mt-6" id="kt_footer">
						<!--begin::Container-->
