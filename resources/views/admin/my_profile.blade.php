                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-muted">{{  Str::ucfirst(Auth::user()->role) }}</div>
                                </div>
                            </div>
                            <!--end::User-->
                            <!--begin::Contact-->
                            <div class="py-9">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <span class="text-muted">{{ Auth::user()->number }}</span>
                                </div>
                                <div class="d-flex align-items-center justify-content-between">
                                    <span class="font-weight-bold mr-2">Joined :</span>
                                    <span class="text-muted"> {{ Carbon\Carbon::parse(Auth::user()->created_at )->format('M d Y') }} </span>
                                </div>
                            </div>
                            <!--end::Contact-->
                            <!--begin::Nav-->
